...
interface NavbarProps {
  ...
  /** Kept for API compatibility; terminate now lives in the game detail panel. */
...
export function Navbar({
  ...
  const navItems = controllerMode
    ? [
        ...
        { id: "favorites", page: "favorites" as const, label: t("navigation.favoritesShort"), icon: Heart },
  ...
  return (
    <nav className={`navbar${controllerMode ? " navbar--controller" : ""}`}>
      <div className="navbar-left">
        <div className={`navbar-brand${activeSession ? " navbar-brand--streaming" : ""}`}>
      ...
      <div className="navbar-right">
        {/* PERF/UX: the old "Resume <game> + Terminate" bar lived here and overlapped the
            Settings tab on narrow windows. Resume now lives on the streaming pill (navbar
            centre) and Terminate moved into the game detail panel + stream quick menu. */}
