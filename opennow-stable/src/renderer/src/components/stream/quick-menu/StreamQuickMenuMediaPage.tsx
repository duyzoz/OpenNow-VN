    ...
    <div className="sidebar-page" role="tabpanel">
      ...
      <section className="sidebar-section">
        <div className="sidebar-section-header">
          ...
          <span className="sidebar-section-sub">{t("stream.quickMenu.media.screenshotShortcut", { shortcut: screenshotShortcut })}</span>
        </div>
        ...
        <div className="sidebar-gallery-row">
          <button
            ...
            aria-label={t("stream.quickMenu.media.scrollLeft")}
          >
            <ChevronLeft size={16} />
          </button>
          ...
          <button
            ...
            aria-label={t("stream.quickMenu.media.scrollRight")}
          >
            <ChevronRight size={16} />
          </button>
        </div>
        {screenshots.length === 0 && (
          <span className="sidebar-hint">{t("stream.quickMenu.media.emptyScreenshots", { shortcut: screenshotShortcut })}</span>
        )}
      ...
      <section className="sidebar-section">
        <div className="sidebar-section-header">
          ...
          <span className="sidebar-section-sub">{t("stream.quickMenu.media.recordingShortcut", { shortcut: recordingShortcut })}</span>
        </div>
        {usedMimeType && (
        ...
        {recordings.length === 0 ? (
          <span className="sidebar-hint">{t("stream.quickMenu.media.emptyRecordings", { shortcut: recordingShortcut })}</span>
        ) : (
          <div className="sidebar-gallery-row">
            <button
              type="button"
                ...
                <div key={recording.id} className="sidebar-rec-card">
                  ...
                  <div className="sidebar-rec-card-actions">
                    ...
                    <button
                      ...
                      aria-label={t("stream.quickMenu.media.delete")}
